...
$email = get_theme_mod('contact_email', 'nelsonalejandroramosrivera@gmail.com');
...
<section class="contact-section sport-card contact-card animate-fade-in stagger-2 no-print">
    <h3 class="contact-title">
        <?php autocreativa_e('contact_title'); ?>
    </h3>
    <p class="contact-subtitle text-subtle">
        <?php autocreativa_e('contact_subtitle'); ?>
    </p>

    <div class="contact-email-wrapper">
        <button type="button" class="contact-btn" id="show-email-btn">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                <polyline points="22,6 12,13 2,6"></polyline>
            </svg>
            <?php autocreativa_e('contact_cta'); ?>
        </button>

        <div class="email-display" id="email-display" style="display: none;">
            <div class="email-input-wrapper">
                <input type="text" value="<?php echo esc_attr($email); ?>" readonly class="email-input" id="email-text">
                <button type="button" class="copy-btn" id="copy-email-btn"
                    aria-label="<?php esc_attr_e('Copy email', 'autocreativa'); ?>">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span class="copied-message" id="copied-message">
                <?php autocreativa_e('contact_copied'); ?>
            </span>
        </div>
    </div>
    ...
    <div class="social-links">
        <?php if ($github): ?>
            <a href="<?php echo esc_url($github); ?>" target="_blank" rel="noopener noreferrer" class="social-link"
                aria-label="GitHub">
