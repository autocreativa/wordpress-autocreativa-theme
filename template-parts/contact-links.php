<?php
/**
 * Template Part: Contact Links (Email & Social)
 *
...
<section class="contact-links-section animate-fade-in stagger-4 no-print">
...
.contact-email-link:hover {
    ...
    box-shadow: 0 4px 15px rgba(190, 242, 100, 0.15); /* Lime subtle glow */
}

/* Social links styles remain the same but included for completeness */
.social-links {
    display: flex;
    align-items: center;
    justify-content: center;
